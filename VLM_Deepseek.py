...
all_prompts = pd.read_csv("/Users/just/Documents/ERM/Thesis stuff/dolomites_50_landscape_descriptions_deepseek.csv")
...
output_path = Path("/Users/just/Documents/ERM/Thesis stuff/Output of LPE Deepseek/ensembling_preds_no_gt.gpkg")
