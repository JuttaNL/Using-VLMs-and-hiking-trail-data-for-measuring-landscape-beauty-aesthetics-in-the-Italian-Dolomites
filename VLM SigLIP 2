...
all_prompts = pd.read_csv("/Users/just/Documents/ERM/Thesis stuff/dolomites_landscape_descriptions_cleaned.csv")
...
print(f"\n⚠️ Number of unmatched image IDs: {len(unmatched_ids)}")
if unmatched_ids:
    print("🔍 Example unmatched IDs:")
    ...
    print(f"📝 Exported unmatched images to: {unmatched_csv_path}")
...
output_path = Path("/Users/just/Documents/ERM/Thesis stuff/Output of LPE/ensembling_preds_no_gt.gpkg")
